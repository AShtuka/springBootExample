...
<@c.page>
            ...
            <div class="form-group mt-3">
                <form method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" class="form-control ${(textError??)?string('is-invalid','')}" value="<#if message??>${message.text}</#if>" name="text" placeholder="Input message" />
                        <#if textError??>
        ...
        <div class="card-columns">
                ...
                <div class="card my-3">
                        <#if message.filename??>
                            <img src="/D:/img/${message.filename}" class="card-img-top">
                        </#if>
                        <div class="m-2">
